...
if ($_GET) {
    if ($page == "createseries") {
        if ($_SESSION['role'] == "staff") {
            ...
            header("Location: errors.php?error=restricted");
            exit();
        }
...
switch ($request) {
    ...
    case '/createseries':
        if ($_SESSION['role'] == "staff") {
            require __DIR__ . 'administration/createSeries.php';
        } else {
            require __DIR__ . 'errors.php?error=restricted';
        }
        break;
    case '/createchapter':
        if ($_SESSION['role'] == "staff") {
            require __DIR__ . 'administration/chapter.php';
        } else {
            require __DIR__ . 'errors.php?error=restricted';
        }
        break;
    case '/reader':
        ...
        break;
    case '/signup':
        require 'pages/SignupBody.php';
        break;
    case '/login':
        require 'pages/loginBody.php';
        break;
    case '/logout':
